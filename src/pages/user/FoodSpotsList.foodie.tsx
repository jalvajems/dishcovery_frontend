...
export default function FoodSpotListing() {
  ...
  const handleFetchSpots=async()=>{
    try {
      const res=await getAllFoodSpotApi(currentPage,limit,searchQuery);
            ...
            >
              <div className="flex gap-6 items-center">
                <div className="flex-1">
                  ...
                  <button onClick={()=>navigate(`/foodie/foodspot/${spot._id}`)} className="flex items-center gap-2 px-6 py-3 bg-gray-100 rounded-xl font-semibold hover:bg-green-100 hover:text-green-700 transition">
                    View Details
                    <ArrowRight />
                  </button>
                </div>
