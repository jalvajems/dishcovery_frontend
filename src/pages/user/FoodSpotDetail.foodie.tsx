...
import { MapPin, Clock, Heart, Share2, ChevronLeft, Star, Navigation } from 'lucide-react';
...
export const FoodSpotDetailPage: React.FC = () => {
  const { id } = useParams();
...
export default FoodSpotDetailPage;